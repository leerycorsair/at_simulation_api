...
Revision ID: 1fac32417ea3
Revises: 
Create Date: 2024-08-25 10:59:37.894075
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['model_id'], ['models.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name', 'model_id', name='uix_node_name_model_id')
    )
    ...
    op.create_table('irregular_event_generator',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('type', sa.Enum('NORMAL', 'PRECISE', 'RANDOM', 'UNIFORM', 'EXPONENTIAL', 'GAUSSIAN', 'POISSON', name='irregulareventgeneratortypeenum'), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_table('irregular_event_generator')
